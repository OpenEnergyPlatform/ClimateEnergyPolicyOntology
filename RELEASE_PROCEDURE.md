...
For a **Patch Release** (Hotfix), start at [section 3](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/blob/production/RELEASE_PROCEDURE.md#4--create-a-draft-github-release).

### 1. 🐙 Create a `GitHub Project`

- Create [New classic project](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/projects?type=classic)
...
- Use [`📝issue_template_release`](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/issues/new?template=issue_template_release.md)
...
- [Draft a new release](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/releases/new)
...
**Complete changelog:** [CHANGELOG.md](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/blob/production/CHANGELOG.md)
**Compare versions:** [0.1.0 - 0.2.0](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/compare/v0.1.0...v0.2.0)
...
- Check [GitHub Action](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/actions/workflows/publish_pypi.yml)
...
- Create a [Pull Request](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/compare) from `production` to `develop`
...
- Create a new [GitHub Project](https://github.com/OpenEnergyPlatform/ClimateEnergyPolicyOntology/projects?query=is%3Aopen) by cloning the latest project
