...
For a **Patch Release** (Hotfix), start at [section 3](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/blob/production/RELEASE_PROCEDURE.md#4--create-a-draft-github-release).

### 1. 🐙 Create a `GitHub Project`

- Create [New classic project](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/projects?type=classic)
...
- Use [`📝issue_template_release`](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/issues/new?template=issue_template_release.md)
...
- [Draft a new release](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/releases/new)
...
**Complete changelog:** [CHANGELOG.md](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/blob/production/CHANGELOG.md)
**Compare versions:** [0.1.0 - 0.2.0](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/compare/v0.1.0...v0.2.0)
...
- Create new tag: 💠`git tag -a v0.1.0 -m "Minor Release v0.1.0"`
...
- Check [GitHub Action](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/actions/workflows/publish_pypi.yml)
...
- Create a [Pull Request](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/compare) from `production` to `develop`
...
- Create a new [GitHub Project](https://github.com/OpenEnergyPlatform/climate-energy-policy-ontology/projects?query=is%3Aopen) by cloning the latest project
